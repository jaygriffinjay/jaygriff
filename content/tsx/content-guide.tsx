import { Heading, Paragraph, List, ListItem, Code, Link } from '@/components/Primitives';
...
export const metadata: PostMeta = {
  ...
  description: 'How to interpret content labels, understand workflow transparency badges, and what guarantees (or lack thereof) apply to content on this site.',
};

export default function ContentGuide() {
  return (
    <>
      <Heading level={2}>Important Disclaimers</Heading>
      ...
      <Paragraph>
        This site is my personal operating system for knowledge work. Publishing everything (even rough drafts and AI explorations) serves multiple purposes:
      </Paragraph>
      <List>
        <ListItem><strong>Version control as changelog</strong> - Git history shows evolution of thinking</ListItem>
        <ListItem><strong>Public learning</strong> - Errors and corrections are visible</ListItem>
        <ListItem><strong>Velocity over polish</strong> - Ship ideas fast, refine later if needed</ListItem>
        <ListItem><strong>Transparency</strong> - Show the messy process, not just clean outcomes</ListItem>
        <ListItem><strong>AI experimentation</strong> - Test what AI can generate at scale</ListItem>
      </List>
      <Paragraph>
        If a page turns out to be wrong or outdated, that's visible in git history. The site evolves with my understanding. Some pages will never be edited again. Some will be refined continuously. That's intentional.
      </Paragraph>

      <Heading level={2}>Content Categories & Badges</Heading>
      <Paragraph>
      ...
      <Heading level={3}>🤖 AI-Generated (100% AI)</Heading>
      <List>
        <ListItem><strong>Author:</strong> None listed (I'm the publisher/curator)</ListItem>
        ...
        <ListItem><strong>What this means:</strong> Expect smooth AI texture—balanced, diplomatic, characteristic hedging patterns. I judged it worth sharing as-is.</ListItem>
      ...
      <Heading level={3}>🔧 AI-Assisted</Heading>
      <List>
        <ListItem><strong>Author:</strong> Jay Griffin</ListItem>
      ...
      <Heading level={3}>✍️ Human-Written</Heading>
      <List>
        <ListItem><strong>Author:</strong> Jay Griffin</ListItem>
      ...
      <Heading level={2}>What Labels Tell You</Heading>
      <Paragraph>
        These labels aren't about giving AI "credit." They're informational signals to help you calibrate:
      </Paragraph>
      <List>
      ...
      <List>
        <ListItem><strong>Professional advice</strong> - Legal, financial, medical claims</ListItem>
      ...
      <Paragraph>
        The AI-assisted label combined with MIT-style licensing sets clear expectations: This is shared work, not authoritative truth. Test it yourself.
      </Paragraph>
      ...
      <Heading level={2}>How Labels Appear</Heading>
      <Paragraph>
        You'll see workflow transparency indicators in:
      </Paragraph>
      <List>
        <ListItem><strong>Metadata headers</strong> - Author and authorship note fields</ListItem>
        <ListItem><strong>Badges</strong> (future) - Visual indicators on content cards</ListItem>
        <ListItem><strong>Content headers</strong> (future) - Banner at top of AI-generated pages</ListItem>
        <ListItem><strong>Navigator filters</strong> (future) - Filter by creation method</ListItem>
      </List>
      <Paragraph>
        Not every page will have a label. Absence of label doesn't imply 100% human—it might just mean I haven't added metadata yet. When in doubt, assume AI-assisted unless noted otherwise.
      </Paragraph>

      <Heading level={2}>This Guide Itself</Heading>
      <Paragraph>
        <strong>This page:</strong> 🔧 AI-Assisted
      </Paragraph>
      <Paragraph>
        I prompted for a comprehensive guide based on the framework in <Code>/posts/ai-workflow-transparency</Code>. AI generated the structure and most prose. I edited for voice, removed redundant sections, and added specific examples. The core ideas came from my existing thinking; AI assembled them into this format.
      </Paragraph>
      <Paragraph>
        <strong>Accuracy of this page:</strong> High. The disclaimers and standards are what I actually commit to. But the specifics of implementation (badges, filters) are aspirational—not all features exist yet.
      </Paragraph>
      ...
      <List>
        <ListItem><Link href="/posts/ai-workflow-transparency">AI Workflow Transparency: A Framework</Link> - Full philosophical exploration</ListItem>
        <ListItem><Link href="/docs/about-authorship">About Authorship</Link> - Why AI isn't a co-author</ListItem>
        <ListItem><Link href="/docs/about-this-site">About This Site</Link> - What this system is and how it works</ListItem>
      </List>
    </>
  );
}
